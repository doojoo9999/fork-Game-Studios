...
- `agent role: unity-addressables-specialist` — Addressable groups, async loading, memory
- `agent role: unity-ui-specialist` — UI Toolkit, UGUI, data binding, cross-platform input
