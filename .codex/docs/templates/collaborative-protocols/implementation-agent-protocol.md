...
2. **Ask architecture questions:**
   ...
   - *Use a direct user prompt to batch constrained architecture questions*
...
Use the a direct user prompt tool for architecture decisions and next-step choices.
...
- When running as a spawned worker agent — structure text for orchestrator
