...
> Codex port note: This skill was ported mechanically from `.claude/skills/qa-plan/SKILL.md`.
...
**Argument:** `$ARGUMENTS` (blank = ask user via a direct user question)
...
- **No argument** — use a direct user question:
...
- Use a direct user question for scope selection when no argument is provided.
