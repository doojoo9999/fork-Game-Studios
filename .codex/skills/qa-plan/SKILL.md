...
**Argument:** `$ARGUMENTS` (blank = ask user by asking the user directly)
...
- **No argument** — use a direct user prompt:
...
- Use a direct user prompt for scope selection when no argument is provided.
