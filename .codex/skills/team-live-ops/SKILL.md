...
> Codex port note: This skill was ported mechanically from `.claude/skills/team-live-ops/SKILL.md`.
...
- `agent role: live-ops-designer` — Season/event structure and retention mechanics
- `agent role: economy-designer` — Live economy balance and reward pricing
- `agent role: analytics-engineer` — Success metrics, A/B tests, event instrumentation
- `agent role: community-manager` — Player-facing communication and messaging
- `agent role: narrative-director` — Seasonal theme and narrative framing
- `agent role: writer` — All player-facing text: event descriptions, item names, copy
