...
- `agent role: ux-designer` — User flows, wireframes, accessibility, input handling
- `agent role: ui-programmer` — UI framework, screens, widgets, data binding
- `agent role: art-director` — Visual style, layout polish, art bible consistency
- `agent role: [UI engine specialist]` — Engine-specific UI pattern validation (e.g., unity-ui-specialist, ue-umg-specialist, godot-specialist)
- `agent role: accessibility-specialist` — Accessibility compliance audit
